...
void arde_point_mass_update_acceleration(arde_point_mass_t* point_mass, int point_mass_count, arde_point_mass_t* point_masses)
{
    ...
    for (int other_point_mass_index = 0; other_point_mass_index < point_mass_count; ++other_point_mass_index)
    {
        arde_point_mass_t* other_point_mass = &point_masses[other_point_mass_index];
...
{
    arde_draw_circle(framebuffer, point_mass->position[0], point_mass->position[1], 0.01f * powf(point_mass->mass, 0.5f));
}
